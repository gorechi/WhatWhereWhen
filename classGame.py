...
class Game():
    ...
    def __init__(self, obj, chat_id, is_full_game=False):
        ...
        self.questions_list = [] #Создается пустой список вопросов, который наполнится из объекта игры
        self.current_question = None #Устанавливаем, что при создании игры нет текущего вопроса
        self.current_question_number = 0 #Номер текущего вопроса устанавливается как 0
    ...
    def get_question(self):
        ...
        if not self.is_full_game:
            ...
            return self.questions_list[0], False
        ...
        # Если вопросов не осталось, вызывается функция окончания игры.
            ...
            if self.current_question_number < len(self.questions_list) - 1:
                ...
                return self.current_question, self.current_question_number
            else:
                self.end_game()
                return False
